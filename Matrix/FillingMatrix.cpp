...
std::pair<Matrix, std::vector<double>> FillingData::FillingWithFunc_1(size_t n)
{
	Matrix A(n);
	std::vector<double> b(n);
	b[0] = 1;
...
std::pair<Matrix, std::vector<double>> FillingData::FillingWithFunc_2(size_t n)
{
	Matrix A(n);
	std::vector<double> b(n);
	for (size_t i = 0; i < n; ++i)
...
//===================================----2----============================================
std::pair<Matrix, std::vector<double>> FillingData::FillingWithFunc_1_1(size_t n)
{
	Matrix A(n);
	std::vector<double> b(n);
	for (size_t i = 0; i < n; ++i)
...
int FillingData::CheckForFunc_1_1(std::vector<double>& x)
{
